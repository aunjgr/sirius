...
static std::unique_ptr<cudf::filtered_join> make_right_filtered_join(cudf::table_view const& right,
                                                                     rmm::cuda_stream_view stream)
{
#if CUDF_VERSION_MAJOR > 26 || (CUDF_VERSION_MAJOR == 26 && CUDF_VERSION_MINOR >= 10)
  return std::make_unique<cudf::filtered_join>(right, cudf::null_equality::UNEQUAL, stream);
#else
